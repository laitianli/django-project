"""
Django settings for regloginout project.
...
SECRET_KEY = 'django-insecure-h5l0s_$5n+!159802yz=%+-x5w)mgl)*&j^3t+)=fy-f2hpb!@'
...
WSGI_APPLICATION = 'regloginout.wsgi.application'
